...
public class DBService {
	...
	public void instaciaDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Afrain Calixto", "calixtoafrain@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, cryptSenha.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Carmo", "afrainsilva@hotmail.com", "93449609092",
				TipoCliente.PESSOAFISICA, cryptSenha.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Av. Santa Terezina", "S/N", "QD 01 LT 15/16 CASA 2", "Res. Goiani",
				"74355507", cli2, c2);
