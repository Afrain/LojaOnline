package com.afrain.lojaonline.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		HttpStatus httpAmazon = HttpStatus.valueOf(e.getErrorCode());
		StandardError err = new StandardError(httpAmazon.value(), e.getMessage(), System.currentTimeMillis());
		return ResponseEntity.status(httpAmazon).body(err);
	}
